...
namespace DM
{
    public class ControlManager : MonoBehaviour
    {
        ...
        public float sprintSpeed = 10f; //speed of sprinting(double time of running)
        ...
        [Header("States")]
        public bool onGround = true; //shows you are on ground or not.
        ...
        void Start() // Initiallizing camera, animator, rigidboy
        {
            ...
            rigid = characterController.GetRigidbody();
        ...
        {
            // get input from character controller attached too
            if (characterController != null)
            {
                normalAttack = characterController.GetItemActionFloat() == 1.0f;
                canMove = !normalAttack;
                vertical = characterController.GetForwardMovement();
                horizontal = characterController.GetLeftRightMovement();
                sprint = characterController.GetIsSprinting();
            }
            //Debug.Log("vert"+vertical);
            /*
            else
            {
                // TODO more options for attack animation
        ...
        void UpdateStates() //updates character's various actions.
        {
            ...
            /*
            if (
                jump //I clicked jump, left mouse button or B key in the joypad.
            )
            {
                if (
                    onGround && canMove //do jump only when you are on ground and you can move.
                )
                {
            ...
            */
            /*
            if (
                comboAttack //I clicked for combo attack. right mouse button or X key in the joypad.
            )
            {
                if (
                    onGround //only when you are on ground.
                )
                {
            ...
            */
            ...
            /*
            if (
                roll && onGround //I clicked for roll. middle mouse button or Y key in the joypad.
            )
            {
            ...
            */
            ...
            // TODO get this back from nick chara controler
            /*
            ...
            */
            ...
            /*
            if (
                normalAttack && canMove // I clicked for normal attack when I can move around.
            )
            */
            if (
                normalAttack  // I clicked for normal attack when I can move around.
            )
            {
                string targetAnim;
                ...
                Debug.Log("starting animtion for " + targetAnim);
